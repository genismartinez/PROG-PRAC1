...
public class UsaVideo {
    ...
    public static void main(String[] args) {
        ...
        Video v4 = new Video("Alias04", "Crear un getter", "Lab04", fechaV4, 124);
     ...
     //provaV(Video,moreLikes,moreVisus,moreSaved)
       ...
       provaModifV(v3,84,400,56);	//V3
       provaModifV(v4,11,76,6);		//V4
       provaModifV(v5,60,320,28);	//V5
       provaModifV(v6,8,24,3);		//V6
       provaCopia(v1,v2);			//probamos de copiar v1 a v2
       checkIfUseful(v3);			//comprobamos si se considera util
       checkMoreSaved(v4,v5);		//comprobamos cual se ha guardado mas veces
       pruebaLonger(v1,v2);			//devuelve una copia del video mas largo
       provaMitjanaVisus(v6);		//comprobamos si funciona el metodo que calcula la media visus/dia
       benValorat(v4);				//comprobamos si esta bien valorado depen. del lindar usado
    }
